...
237 kinds. A kind name spells out everything Understand knows
about a declaration -- `Java Static Final Generic Method Public Member`
is one kind, not five attributes.
...
53 pairs, 106 kinds. Every reference is stored twice,
once in each direction, at the same file, line and column.

| Forward | Inverse | Produced |
| --- | --- | --- |
| `Java Begin` | `Java Beginby` | yes |
