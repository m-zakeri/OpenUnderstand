 ...
 * the figure.
 * <p>
 * Usually, DragHandle is not needed, because of the {@link org.jhotdraw.draw.tool.DragTracker} in
 * the |@code SelectionTool}. Use a (subclass of) {@code DragHandle}, if you want to implement
