...
class  JavaParserLabeled : public antlr4::Parser {
public:
  enum {
  ...
  explicit JavaParserLabeled(antlr4::TokenStream *input);
  ~JavaParserLabeled();
  ...
  public:
    JavaParserLabeled::BlockContext *constructorBody = nullptr;
  ...
  public:
    ...
    JavaParserLabeled::ExpressionContext *statementExpression = nullptr;
    antlr4::tree::TerminalNode *SEMI();
    ExpressionContext *expression();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  ...
  public:
    ...
    JavaParserLabeled::BlockContext *blockLabel = nullptr;
    BlockContext *block();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  };
  ...
  public:
    JavaParserLabeled::ExpressionContext *constantExpression = nullptr;
  ...
  public:
    ...
    JavaParserLabeled::ExpressionListContext *forUpdate = nullptr;
    std::vector<antlr4::tree::TerminalNode *> SEMI();
    antlr4::tree::TerminalNode* SEMI(size_t i);
