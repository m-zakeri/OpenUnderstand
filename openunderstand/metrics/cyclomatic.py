...
from utils_g10 import report_cyclomatic, get_method_prefixes
...
def main():
    ...
    for ctx in cyclomatic_counter:
        ...
        if type(ctx).__name__ == 'EnumDeclarationContext':
            ...
            cyclomatic_obj['cyclomatic'] = cyclomatic
            cyclomatic_list.append(cyclomatic_obj)
            ent_kind_set.add(cyclomatic_obj['kind'])

    report_cyclomatic(cyclomatic_listener.project_cyclomatic, ent_kind_set, cyclomatic_list)
