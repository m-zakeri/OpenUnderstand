...
#     db = und.open("C:/Users/PouRiA/Desktop/OU/jvlt-1.3.2.und")
#     for ent in db.ents():
#         for ref in ent.refs("Java Type"):
...
db = und.open(
    "C:/Projects/Git/OpenUnderstandG15/benchmark/calculator_app/src/src.und")
