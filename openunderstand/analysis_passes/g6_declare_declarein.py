...
class DeclareAndDeclareinListener(JavaParserLabeledListener):
    ...
    def enterCompilationUnit(self, ctx: JavaParserLabeled.CompilationUnitContext) -> None:
    ...
    def enterPackageDeclaration(self, ctx: JavaParserLabeled.PackageDeclarationContext) -> None:
        ...
        for i in range(len(full_package_name_array)):
            ...
            data = {"scope": None if i == 0 else full_package_name_array[i - 1].getText(),
                    "entity": entity_name,
