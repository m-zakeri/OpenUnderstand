...
class SetAndSetByListener(JavaParserLabeledListener):
    ...
    def add_set_by_entry(self, set_short_name, set_long_name, name_of_file, line, column, ctx):
        if self.call_function:
            ...
            if (("this" in ctx.children[0].getText()) or (ctx.children[2].getChildCount() <= 1)) and (ctx.getRuleIndex() == 83):
                set_value = None
            else:
                set_value = "String"
                    ...
                    if ctx.children[1].getText() == "=":
                        if ctx.children[0].children[1].getText() == "[":
                            if ctx.children[0].children[0].getChildCount() > 1:
                                line = ctx.children[0].children[0].children[2].symbol.line
                                column = ctx.children[0].children[0].children[2].symbol.column
                                node = ctx
                            ...
                            self.add_set_by_entry(set_short_name, set_long_name, name_of_file, line, column, ctx)
                            set_short_name = node1.children[0].getText()+"."+ctx.children[0].children[2].getText()
                            set_long_name = (
                                    self.package_name
                                    + "."
                                    + node1.children[0].getText()
                            ...
                            if node.getRuleIndex() == 25:
                                set_short_name = node.children[0].getText()+"."+ctx.children[0].children[2].getText()
                                self.stream = node.parentCtx.parentCtx.getText()
                                self.scope_kind = node.parentCtx.parentCtx.children[0].getText()+"."+node.children[0].getText()
                            set_long_name = (
                                    self.package_name
                                    + "."
                            ...
                            line = ctx.children[0].children[0].children[0].children[0].symbol.line
                            column = ctx.children[0].children[0].children[0].children[0].symbol.column
                            self.add_set_by_entry(set_short_name, set_long_name, name_of_file, line, column, ctx)
            ...
            if int(ctx.getChildCount()) > 1 and ctx.children[1].getText() == "=":
                ...
                if ctx.parentCtx.parentCtx.parentCtx.parentCtx.getRuleIndex() == 77:
                    ...
                    if node.getRuleIndex() == 25 :
                        ...
                        set_short_name = node.children[1].getText()+"."+ctx.children[0].getText()
                        set_long_name = (
                                self.package_name
                                + "."
                                + node.children[1].getText()
